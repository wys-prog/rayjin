...
/// HAS_DEFINE LIGHTGRAY  = (Color){ 200, 200, 200, 255 }   // Light Gray
/// HAS_DEFINE GRAY       = (Color){ 130, 130, 130, 255 }   // Gray
/// HAS_DEFINE DARKGRAY   = (Color){ 80, 80, 80, 255 }      // Dark Gray
/// HAS_DEFINE YELLOW     = (Color){ 253, 249, 0, 255 }     // Yellow
/// HAS_DEFINE GOLD       = (Color){ 255, 203, 0, 255 }     // Gold
/// HAS_DEFINE ORANGE     = (Color){ 255, 161, 0, 255 }     // Orange
/// HAS_DEFINE PINK       = (Color){ 255, 109, 194, 255 }   // Pink
/// HAS_DEFINE RED        = (Color){ 230, 41, 55, 255 }     // Red
/// HAS_DEFINE MAROON     = (Color){ 190, 33, 55, 255 }     // Maroon
/// HAS_DEFINE GREEN      = (Color){ 0, 228, 48, 255 }      // Green
/// HAS_DEFINE LIME       = (Color){ 0, 158, 47, 255 }      // Lime
/// HAS_DEFINE DARKGREEN  = (Color){ 0, 117, 44, 255 }      // Dark Green
/// HAS_DEFINE SKYBLUE    = (Color){ 102, 191, 255, 255 }   // Sky Blue
/// HAS_DEFINE BLUE       = (Color){ 0, 121, 241, 255 }     // Blue
/// HAS_DEFINE DARKBLUE   = (Color){ 0, 82, 172, 255 }      // Dark Blue
/// HAS_DEFINE PURPLE     = (Color){ 200, 122, 255, 255 }   // Purple
/// HAS_DEFINE VIOLET     = (Color){ 135, 60, 190, 255 }    // Violet
/// HAS_DEFINE DARKPURPLE = (Color){ 112, 31, 126, 255 }    // Dark Purple
/// HAS_DEFINE BEIGE      = (Color){ 211, 176, 131, 255 }   // Beige
/// HAS_DEFINE BROWN      = (Color){ 127, 106, 79, 255 }    // Brown
/// HAS_DEFINE DARKBROWN  = (Color){ 76, 63, 47, 255 }      // Dark Brown
/// HAS_DEFINE WHITE      = (Color){ 255, 255, 255, 255 }   // White
/// HAS_DEFINE BLACK      = (Color){ 0, 0, 0, 255 }         // Black
/// HAS_DEFINE BLANK      = (Color){ 0, 0, 0, 0 }           // Blank (Transparent)
/// HAS_DEFINE MAGENTA    = (Color){ 255, 0, 255, 255 }     // Magenta
/// HAS_DEFINE RAYWHITE   = (Color){ 245, 245, 245, 255 }   // My own White (raylib logo)
